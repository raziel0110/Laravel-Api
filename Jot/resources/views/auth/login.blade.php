...
<div class="mx-auto h-full flex justify-center items-center bg-gray-300">
    <div class="w-96 bg-blue-900 rounded-lg shadow-xl p-6">
        ...
        <h1 class="pt-6 text-white text-3xl">Welcome Back</h1>
        ...
        <form method="POST" action="{{ route('login') }}" class="pt-6">
            ...
            <div class="relative">
                ...
                <div class="">
                    <input id="email" type="email" class="focus:bg-blue-700 outline-none pt-8 w-full rounded p-3 bg-blue-800 text-gray-100" placeholder="your@email.com" name="email" value="{{ old('email') }}"  autocomplete="email" autofocus>

                    @error('email')
                    <span class="text-red-600 text-sm pt-1k" role="alert"><strong>{{ $message }}</strong></span>
                    @enderror
                </div>
            </div>
            ...
            <div class="relative pt-4">
                ...
                <div class="">
                    <input id="password" type="password" placeholder="your password" class="focus:bg-blue-700 outline-none pt-8 w-full rounded p-3 bg-blue-800 text-gray-100" name="password"  autocomplete="current-password">
